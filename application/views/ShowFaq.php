								...
								<div class="row">
									<div class="col-xs-12">
										<div class="modal-footer" style="background: #fff;border-top: 0px solid #e5e5e5;">			
													...
													<a href="<?php echo base_url();?>Dashboard/Admin/Faq" style="color: #fff;"><button class="btn btn-sm btn-success pull-right">
												<i class="ace-icon fa fa-search-plus bigger-130"></i> Add FAQ</button></a>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center">FAQ Question</th>
														<th class="center">FAQ Answer</th>
														<th class="hidden"></th>
														<th class="hidden"></th>
														<th class="hidden"></th>
														<th></th>														
